    ...
    <div id="app">
        ...
        <div style="width: 1200px; margin-top: 10px; display: flex; flex-direction: row;">
            <div style="flex: 1;">
                ...
                <div>
                    <quill-editor v-model="item.text4" hide-toolbar>
