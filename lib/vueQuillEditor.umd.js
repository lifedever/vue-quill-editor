...
// CONCATENATED MODULE: ./src/QuillEditor.vue?vue&type=template&id=280a93b6&scoped=true&
...
/* harmony default export */ var QuillEditorvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    initQuill: function initQuill() {
      ...
      this.$nextTick(function (_) {
        // init toolbar style
        _this.toolbarEl = _this.$el.querySelector('.ql-toolbar.ql-snow');

        if (_this.toolbarEl) {
          _this.toolbarEl.style.borderColor = _this.borderColor;
        }
      });
    },
