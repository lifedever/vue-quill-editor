...
// CONCATENATED MODULE: ./src/QuillEditor.vue?vue&type=template&id=21b3f692&scoped=true&
...
/* harmony default export */ var QuillEditorvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    initQuill: function initQuill() {
      ...
      this.$nextTick(function (_) {
        // init toolbar style
        _this.$el.querySelector('.ql-toolbar.ql-snow').style.borderColor = _this.borderColor;
      });
    },
