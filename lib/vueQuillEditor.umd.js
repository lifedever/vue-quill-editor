(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vueQuillEditor"] = factory();
	else
		root["vueQuillEditor"] = factory();
...
module.exports = __webpack_require__.p + "img/align-center.5d401424.svg";
...
module.exports = __webpack_require__.p + "img/align-left.a09f86f1.svg";
...
module.exports = __webpack_require__.p + "img/align-right.b5ac91b1.svg";
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"a3ad2ee4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/QuillEditor.vue?vue&type=template&id=4fe1c1d2&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{ref:"editor",staticClass:"vue-quill-editor",style:(_vm.style)},[_vm._t("default")],2),(_vm.showCounter)?_c('div',{staticClass:"ql-counter-desc"},[_vm._v(" 已输入 "+_vm._s(_vm.textLength)),(_vm.maxLength)?_c('span',[_vm._v("/"+_vm._s(_vm.maxLength))]):_vm._e(),_vm._v(" 字 ")]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/QuillEditor.vue?vue&type=template&id=4fe1c1d2&scoped=true&
...
// CONCATENATED MODULE: ./src/modules/imageResize/DefaultOptions.js
...
// CONCATENATED MODULE: ./src/modules/imageResize/modules/BaseModule.js


var BaseModule_BaseModule = function BaseModule(resizer) {
 ...
 */
;
// CONCATENATED MODULE: ./src/modules/imageResize/modules/DisplaySize.js
...
var DisplaySize_DisplaySize = /*#__PURE__*/function (_BaseModule) {
  ...
  function DisplaySize() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onUpdate", function () {
      ...
      if (size[0] > 120 && size[1] > 30) {
        ...
        Object.assign(_this.display.style, {
          right: 'auto',
          bottom: "-".concat(dispRect.height + 4, "px"),
        ...
        Object.assign(_this.display.style, {
          right: "-".concat(_dispRect.width + 4, "px"),
          bottom: "-".concat(_dispRect.height + 4, "px"),
          left: 'auto'
        });
      }
    });
...
var align_center = __webpack_require__("09c6");
...
var align_right = __webpack_require__("be13");
var align_right_default = /*#__PURE__*/__webpack_require__.n(align_right);

// CONCATENATED MODULE: ./src/modules/imageResize/modules/Toolbar.js
...
var Parchment = quill_default.a.imports.parchment;
...
var Toolbar_Toolbar = /*#__PURE__*/function (_BaseModule) {
  ...
  function Toolbar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onCreate", function () {
      ...
      _this._defineAlignments(); // this._addToolbarButtons();
    ...
    _defineProperty(_assertThisInitialized(_this), "_addToolbarButtons", function () {
      ...
      _this.alignments.forEach(function (alignment, idx) {
        ...
        console.log(button); // Object.assign(button.children[0].style, this.options.toolbarButtonSvgStyles);
...
// CONCATENATED MODULE: ./src/modules/imageResize/modules/Resize.js
...
var Resize_Resize = /*#__PURE__*/function (_BaseModule) {
...
// CONCATENATED MODULE: ./src/modules/imageResize/ImageResize.js
...
var knownModules = {
  DisplaySize: DisplaySize_DisplaySize,
...
var ImageResize_ImageResize = function ImageResize(quill) {
  var _this = this;
  ...
  _defineProperty(this, "handleClick", function (evt) {
    if (_this.quill.container.classList.contains('ql-disabled')) {
      // 只读模式
      return;
    }
  ...
  _defineProperty(this, "show", function (img) {
    if (_this.quill.options.readOnly) {
      // readonly
  ...
  _defineProperty(this, "checkImage", function (evt) {
    if (_this.img) {
      if (evt.keyCode == 46 || evt.keyCode == 8) {
        quill_default.a.find(_this.img).deleteAt(0);
      }
  ...
  this.quill.root.addEventListener('click', this.handleClick, false); // 点击框外，失去焦点

  document.body.addEventListener('click', function (e) {
    if (!_this.quill.root.contains(e.target)) {
      _this.hide();
    }
  });
...
/* harmony default export */ var imageResize_ImageResize = (ImageResize_ImageResize);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/QuillEditor.vue?vue&type=script&lang=js&
...
quill_default.a.register('modules/imageResize', imageResize_ImageResize);
/* harmony default export */ var QuillEditorvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    initQuill: function initQuill() {
      ...
      this.quill = new quill_default.a(this.$refs['editor'], config);
      console.log('init quill config: ', config);
      this.$nextTick(function (_) {
        if (_this.value) {
          _this.setHtml(_this.value);
        }

        _this.$emit('input', _this.getHtml());
      });
      this.textLength = this.getLength();
      this.bindEvents();
      console.log('editor container', this.quill.container); // 设置 只读

      setTimeout(function (_) {
        _this.handleReadOnlyChange();
      }, 300);
      this.$nextTick(function (_) {
        // init toolbar style
        _this.$el.querySelector('.ql-toolbar').style.borderColor = _this.borderColor;

        _this.setToolbarSticky();

        _this.fixBugs();
      });
    },
    fixBugs: function fixBugs() {
      this.$el.querySelector('.ql-toolbar').addEventListener('mousedown', function (e) {
        e.preventDefault();
        e.stopPropagation();
      });
    },
    setToolbarSticky: function setToolbarSticky() {
      if (this.toolbarSticky) {
        var toolbar = this.$el.querySelector('.ql-toolbar');
    ...
    bindEvents: function bindEvents() {
      ...
      this.quill.on('text-change', function (delta, oldDelta, source) {
        var text = _this2.getText();

        var html = _this2.getHtml();

        var length = _this2.getLength();

        if (_this2.maxLength && length > _this2.maxLength) {
          _this2.quill.deleteText(_this2.maxLength, length);
        }

        _this2.textLength = _this2.getLength();

        _this2.$emit('input', html);

        _this2.$emit('textChange', {
          delta: delta,
          oldDelta: oldDelta,
          source: source
        });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this3.uploadImage(_this3.imageConfig.multiple ? input.files : input.files[0]).then(function (items) {
                  items.forEach(function (image) {
                    _this3.quill.insertEmbed(range.index, 'image', image);
    ...
    uploadImage: function uploadImage(files) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this4.imageConfig.multiple) {
          files.forEach(function (file) {
            formData.append(_this4.imageConfig.fileName, file);
          });
        } else {
          formData.append(_this4.imageConfig.fileName, files);
        }

        var xhr = new XMLHttpRequest();
        xhr.open('POST', _this4.imageConfig.serverUrl, true);

        if (_this4.imageConfig.withCredentials) {
          ...
          if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
              ...
              if (res.errno === 0) {
                ...
                if (_this4.imageConfig.error) {
                  _this4.imageConfig.error(res);
                }
              ...
              console.log(xhr);
              alert("\u56FE\u7247\u4E0A\u4F20\u5931\u8D25\uFF01".concat(xhr.responseText));
    ...
    setHtml: function setHtml(content) {
...
// CONCATENATED MODULE: ./src/QuillEditor.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/QuillEditor.vue
...
/* harmony default export */ var QuillEditor = (component.exports);
...
/* harmony default export */ var src_0 = (QuillEditor);
...
//# sourceMappingURL=vueQuillEditor.umd.js.map